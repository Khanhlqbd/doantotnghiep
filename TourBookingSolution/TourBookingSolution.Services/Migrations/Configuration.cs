namespace TourBookingSolution.Services.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<TourBookingSolution.Services.EntitiesDbContext>
    {
        ...
        protected override void Seed(TourBookingSolution.Services.EntitiesDbContext context)
        {
